...
export default {
  ...
  methods: {
    ...
    getTableData () {
      ...
      let loanStart = this.loanTime.start || ''
      let loanEnd = this.loanTime.end || ''
      if (loanStart > loanEnd && (![loanStart, loanEnd].includes(''))) {
        return this.$refs.toast.show('放款开始时间需小于结束时间')
      }
      let params = {
        ...this.params,
        fundType: 'advanceMoney',
        page: {
          pageSize: this.limit,
